// app/components/templates/minimalist-template.tsx
'use client'
...
export default function MinimalistTemplate({
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      // --- 4. Draw Elements ---
      ctx.fillStyle = '#F3F4F6'; // Light gray background for minimalist template
      ...
      // --- 5. Draw Text ---
      ctx.fillStyle = '#111827'; // Darker text for light gray background
